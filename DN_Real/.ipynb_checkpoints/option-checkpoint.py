...
parser.add_argument('--n_threads', type=int, default=40,
...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/userhome/dn/HQ/test_data',
...
parser.add_argument('--mode', default='E',
                    help='mode name')
parser.add_argument('--mod',type=str,default='L')
parser.add_argument('--stages',type=int,default=4)
parser.add_argument('--blocks',type=int,default=2)
# parser.add_argumnet('--blocks',type=int,default=2)
...
# Log specifications
parser.add_argument('--save_path',type=str,default='res_dagl_p')
...
parser.add_argument('--sidd_path',type=str,default='/userhome/dn/HQ_ex/RN_data/HQ')
parser.add_argument('--sidd_LQ_path',type=str,default='/userhome/dn/HQ_ex/RN_data/LQ')
