...
# For CAR
parser.add_argument('--q',type=int,default=10,help='Quality factor')
parser.add_argument('--quality',type=int,default=10,help='Quality factor for test')
parser.add_argument("--logdir", type=str, default="res_cola_v2_6_3_40_d300/model/model_best.pt", 
                    help='path of log files')
parser.add_argument("--ensemble",action='store_true')
parser.add_argument("--test_data", type=str, default='classic5', 
                    help='test on Classic5 or LIVE1')
