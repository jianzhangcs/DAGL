...
import time
from model.nlnet import NONLocalBlock2D
...
class CES(nn.Module):
    def __init__(self,in_channels,num=4):
        ...
        # stage 1 (4 head)
        self.n1_1 = NONLocalBlock2D(in_channels=in_channels)
        self.n1_2 = NONLocalBlock2D(in_channels=in_channels)
        self.n1_3 = NONLocalBlock2D(in_channels=in_channels)
        self.n1_4 = NONLocalBlock2D(in_channels=in_channels)
        self.n1_c = nn.Conv2d(in_channels,in_channels,1,1,0)
        # stage 2 (4 head)
        self.n2_1 = NONLocalBlock2D(in_channels=in_channels)
        self.n2_2 = NONLocalBlock2D(in_channels=in_channels)
        self.n2_3 = NONLocalBlock2D(in_channels=in_channels)
        self.n2_4 = NONLocalBlock2D(in_channels=in_channels)
        self.n2_c = nn.Conv2d(in_channels,in_channels,1,1,0)
        # stage 3 (4 head)
        self.n3_1 = NONLocalBlock2D(in_channels=in_channels)
        self.n3_2 = NONLocalBlock2D(in_channels=in_channels)
        self.n3_3 = NONLocalBlock2D(in_channels=in_channels)
        self.n3_4 = NONLocalBlock2D(in_channels=in_channels)
        self.n3_c = nn.Conv2d(in_channels,in_channels,1,1,0)

    def forward(self, x):
        # 4head-3stages
        out = self.n1_c(torch.cat((self.n1_1(x),self.n1_2(x),self.n1_3(x),self.n1_4(x)),dim=1))+x
        out = self.RBS1(out)
        out = self.n2_c(torch.cat((self.n2_1(out),self.n2_2(out),self.n2_3(out),self.n2_4(out)),dim=1))+out
        out  = self.RBS2(out)
        out = self.n3_c(torch.cat((self.n3_1(out),self.n3_2(out),self.n3_3(out),self.n3_4(out)),dim=1))+out
        return out
"""
