...
parser.add_argument('--noiseL',type=int,default=25)
...
parser.add_argument('--logdir',type=str,default='checkpoints/15/model/model_best.pt',
...
parser.add_argument("--test_data", type=str, default='testsets/BSD68', 
                    help='test on Set12, BSD68 and Urban100')
